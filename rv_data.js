...
const DEFAULT_CP = [
  {name:"別府駅（出陣の地）",        lat:33.279240, lng:131.500860, hint:"駅前に立つ「別府観光の父」の銅像。両手を挙げた人物は誰？", flag:"⛩", conf:"確定"},
  {name:"竹瓦温泉",                 lat:33.277456, lng:131.505989, hint:"名物の砂湯。受付で砂の温度を聞け", flag:"♨", conf:"確定"},
  {name:"竹瓦小路アーケード",         lat:33.277033, lng:131.505911, hint:"日本最古級の木造アーケード。何造り？", flag:"🏮", conf:"確定"},
  {name:"別府タワー",               lat:33.281771, lng:131.505917, hint:"展望階は何階？", flag:"🗼", conf:"確定"},
  {name:"別府公園",                 lat:33.281557, lng:131.491006, hint:"園内の竹林で一枚。合言葉を探せ", flag:"🌳", conf:"確定"},
  {name:"別府市役所",               lat:33.284492, lng:131.491173, hint:"別府市の市の花は？", flag:"🏛", conf:"候補"},
  {name:"浜脇温泉",                 lat:33.269986, lng:131.508196, hint:"別府八湯最古。何時代から湧く？", flag:"♨", conf:"確定"},
  {name:"別府ラクテンチ",            lat:33.274941, lng:131.485536, hint:"名物レース。何の動物が走る？", flag:"🎡", conf:"確定"},
  {name:"杉乃井ホテル（観海寺温泉）",  lat:33.284250, lng:131.473929, hint:"棚湯から見える湾の名は？", flag:"♨", conf:"確定"},
  {name:"堀田温泉",                 lat:33.275500, lng:131.459300, hint:"別府八湯のひとつ。入浴料は？", flag:"♨", conf:"候補"},
  {name:"別府ロープウェイ",           lat:33.277901, lng:131.448759, hint:"山頂までの所要は約何分？", flag:"🚡", conf:"確定"},
  {name:"鶴見山上権現（鶴見岳山頂）",  lat:33.285961, lng:131.429952, hint:"鶴見岳の標高は？", flag:"⛩", conf:"確定"},
  ...
  {name:"明礬温泉 湯の里",           lat:33.319630, lng:131.453800, hint:"湯の花の結晶は何色？", flag:"♨", conf:"確定"},
  ...
  {name:"海地獄",                   lat:33.316812, lng:131.468738, hint:"コバルトブルーの正体となる成分は？", flag:"🔥", conf:"確定"},
  {name:"鬼石坊主地獄",              lat:33.315289, lng:131.469613, hint:"足湯の温度は？", flag:"🔥", conf:"確定"},
  {name:"かまど地獄",               lat:33.316388, lng:131.472391, hint:"飲泉は1杯何円？", flag:"🔥", conf:"確定"},
  ...
  {name:"血の池地獄",               lat:33.327173, lng:131.478173, hint:"日本最古の天然地獄。赤の正体は？", flag:"🩸", conf:"確定"},
  {name:"龍巻地獄",                 lat:33.327141, lng:131.479401, hint:"間欠泉の噴出間隔は何分？", flag:"💨", conf:"確定"},
